...
export const stackRouter = router({
  createStack: publicProcedure.input(stackInput).mutation(async (opts) => {
    const res = await stackController.controlCreateStack(opts.input, opts.ctx.db);
    return res;
  }),
  ...
  getAllStacksFromMap: publicProcedure.input(z.string()).query(async (opts) => {
    const res = await stackController.controlGetAllStacksFromMap(opts.input, opts.ctx.db);
    return res;
  }),

  getDirectChildsFromParent: publicProcedure.input(z.string()).query(async (opts) => {
  ...
  getParentFromStack: publicProcedure.input(z.string()).query(async (opts) => {
    const res = await stackController.controlGetParentFromStack(opts.input, opts.ctx.db);
    return res;
  }),
  ...
  changeParentStack: publicProcedure
    ...
    .mutation(async (opts) => {
      const res = await stackController.controlChangeParentStack(opts.input, opts.ctx.db);
      return res;
    }),
