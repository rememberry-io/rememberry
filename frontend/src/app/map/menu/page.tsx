// root page
"use client";
import FlowBackground from "@/components/Flow/FlowBackground/flowBackground";
...
import { useStore } from "../../../components/Flow/FlowElements/mapStore";
...
function MapMenu() {
  ...
  const mapCards = sortedCategories.map((map) => (
    <>
